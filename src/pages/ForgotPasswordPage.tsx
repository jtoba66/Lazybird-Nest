                ...
                <div className="w-full max-w-md animate-scale-in">
                    ...
                    <div className="text-center mb-8">
                        <div className="w-24 h-24 sm:w-32 sm:h-32 flex items-center justify-center mx-auto mb-2 transform rotate-3 hover:rotate-6 transition-all duration-500 group">
                            <img src={nestLogo} alt="Nest Logo" className="w-full h-full object-contain mix-blend-multiply scale-150 group-hover:scale-[1.65] transition-transform duration-700" />
                        </div>
